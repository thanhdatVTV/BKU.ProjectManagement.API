...
{
    public class AppCourseConfiguration : IEntityTypeConfiguration<AppCourse>
    {
        public void Configure(EntityTypeBuilder<AppCourse> builder)
        {
            builder.ToTable("AppCourse");
            ...
            builder.HasIndex(x => x.SsoCourseId).IsUnique();
        }
    }
}
